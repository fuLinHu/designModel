package com.luban.oauth2demo.config.jwt;

import com.luban.oauth2demo.config.jwt.enhancer.JwtTokenEnhancer;
...
public class AuthorizationServerConfig3 extends AuthorizationServerConfigurerAdapter {
    ...
    public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
        ...
        /**
         *授权码模式
         *http://localhost:7000/oauth/authorize?response_type=code&client_id=client&redirect_uri=http://localhost:8081/login&scope=all
         *http://localhost:7000/oauth/authorize?response_type=code&client_id=client&redirect_uri=https://www.baidu.com/&scope=all
         *
         * password模式
        ...
        clients.inMemory()
                ...
                .redirectUris("http://localhost:7001/login",
                        "http://localhost:7002/login","https://www.baidu.com/")
                //自动授权配置
                .autoApprove(true)
                //配置申请的权限范围
                .scopes("all")
