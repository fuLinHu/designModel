...
@Slf4j
@Component
public class TigerTimeMonitorGatewayFilterFactory extends AbstractNameValueGatewayFilterFactory {
    ...
    public static class TimeMonitorGatewayFilter implements GatewayFilter, Ordered {
        ...
        public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
            ...
            log.info("nameValueConfig name:"+name+" value:"+value);
